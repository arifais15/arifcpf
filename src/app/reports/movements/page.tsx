        ...
        <div className="overflow-x-auto">
          <Table className="w-full text-[8px] font-black table-fixed border-collapse text-[#000000]">
            <TableHeader className="bg-slate-100 border-b border-black uppercase text-[7px] leading-tight">
              <tr>
                <th className="border-r border-black p-0.5 w-[40px]">ID No</th>
                <th className="border-r border-black p-0.5 text-left w-[110px]">Personnel Name</th>
                ...
                <th className="text-right border-r p-0.5 w-[75px] bg-slate-200">E-Close</th>
                ...
                <th className="text-right border-r p-0.5 w-[75px] bg-slate-200">P-Close</th>
            ...
            <TableBody className="tabular-nums">
              {reportData.map((r, i) => (
                <TableRow key={i} className="border-b border-black hover:bg-slate-50 h-8">
                  ...
                  <td className="p-0.5 border-r border-black truncate uppercase font-black">{r.name}</td>
                  <td className="text-right p-0.5 border-r bg-slate-50">{r.opE.toLocaleString()}</td>
                  ...
                  <td className="text-right p-0.5 border-r bg-slate-100 font-bold">{r.clE.toLocaleString()}</td>
                  <td className="text-right p-0.5 border-r bg-slate-50">{r.opP.toLocaleString()}</td>
                  ...
                  <td className="text-right p-0.5 border-r bg-slate-100 font-bold">{r.clP.toLocaleString()}</td>
                  <td className="text-right p-0.5 bg-slate-200 font-black"> {r.total.toLocaleString()}</td>
                </TableRow>
              ))}
            </TableBody>
