...
import { Printer, Loader2, Search, ArrowRightLeft, ArrowLeft, FileSpreadsheet, ShieldCheck } from "lucide-react";
        ...
        <div className="hidden print:block text-center mb-8 text-black">
          ...
          <div className="mt-6 flex justify-center">
            <div className="border-4 border-black px-12 py-2">
              <h2 className="text-xl font-black uppercase tracking-[0.4em]">Fund Movement Analysis Matrix</h2>
            </div>
          </div>
          ...
          <Table className="w-full text-[8px] font-black table-fixed border-collapse text-[#000000]">
            <TableHeader className="bg-slate-100 border-b-2 border-black uppercase text-[7px] leading-tight">
              <TableRow className="bg-slate-200 border-b-2 border-black">
                <TableHead colSpan={2} className="border-r-2 border-black bg-slate-300 h-10"></TableHead>
                <TableHead colSpan={4} className="text-center border-r-2 border-black bg-blue-50/50 font-black text-black h-10">Employee Fund Movements</TableHead>
                <TableHead colSpan={4} className="text-center border-r-2 border-black bg-emerald-50/50 font-black text-black h-10">PBS Fund Movements</TableHead>
            ...
            <TableFooter className="hidden print:table-footer-group bg-slate-100 text-black font-black border-t-4 border-black">
              <TableRow className="h-12 font-black text-black">
                <TableCell colSpan={2} className="text-right pr-4 uppercase font-black text-[10px] border-r-2 border-black">Institutional Matrix Totals:</TableCell>
                ...
                <TableCell className="text-right border-r border-black">{stats.adjE.toLocaleString()}</TableCell>
                ...
                <TableCell className="text-right border-r border-black">{stats.adjP.toLocaleString()}</TableCell>
